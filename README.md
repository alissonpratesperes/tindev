...
- Execute o *BackEnd*: **cd tindev > enter > cd backend > npm/yarn install > enter > concluído? > code .**. No *VS Code* acesse o arquivo **src/server.js** e configure a **URL da MongoDB**; Rode o *BackEnd* com o comando **npm/yarn dev**;
